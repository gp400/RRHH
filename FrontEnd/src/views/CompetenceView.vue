...
<script setup lang="ts">
    ...
    const title = 'Competencias';
    const btnText = 'Crear Competencia';
    const itemsPerPageText = 'Competencias por pagina'

    const formRef = ref<InstanceType<typeof VForm> | null>(null);
    const formData = ref(new Competence());

    const items = ref<Competence[]>([]);
    ...
    const onDelete = async (values: Competence) => {
    try {
